...
<body>
    <header class="header">
        <div class="menu Contenedor">
            <a href="/index.php" class="logo">PIURA</a>
    ...
    <section class="section1">
        ...
        <div class="section1Contenido Contenedor">
            ...
            <a href="carrito.html" class="boton1">¡COMPRA YA!</a>
        </div>
    </section>
    ...
    <section class="blog Contenedor">
        ...
        <div class="blogContenido">
            <div class="blog1">
                <img src="/src/views/img/images/blog1.png" alt="">
                <h3>DUEÑO</h3>
                <p>
            ...
            <div class="blog1">
                <img src="/src/views/img/images/blog2.png" alt="">
                <h3>ADMINISTRADOR</h3>
                <p>
            ...
            <div class="blog1">
                <img src="/src/views/img/images/blog3.png" alt="">
